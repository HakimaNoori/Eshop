...
const Navbar = ({ handleOrderPopup }) => {
  return (
    <div className="bg-white dark:text-white dark:bg-gray-900 duration-200 relative z-40">
      <div className="py-4">
                  ...
                  <div className="absolute z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white shadow-md dark:bg-gray-900 p-2 dark:text-white">
                    <ul className="space-y-2">
                      {DropdownLinks.map((data, index) => (
                        <li key={index}>
                          <a
                            className="text-gray-500 hover:text-black dark:hover:text-white duration-200 inline-block w-full p-2 dark:text-white hover:bg-primary/20 rounded-md font-semibold"
                            href={data.link}
                          >
                            {data.name}
                          </a>
